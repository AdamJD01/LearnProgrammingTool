//the form for learning If Statements section
using System;
...
namespace LearnProgrammingTool
{
    public partial class frmIfStatements : Form
    {
        ...
        {
            ifStatements_QuestionsTableAdapter.Fill(exercisesDataSet.IfStatements_Questions); //get the questions table from the database
            ifStatements_AnswersTableAdapter.Fill(exercisesDataSet.IfStatements_Answers); //get the answers table from the database
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            ifStatements_QuestionsBindingSource.MoveNext(); //show next question 
            ifStatements_AnswersBindingSource.MoveNext(); //update next answer
