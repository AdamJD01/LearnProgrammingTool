//the form for learning Loops section
using System;
...
namespace LearnProgrammingTool
{
    public partial class frmLoops : Form
    {
        ...
        {
            loops_QuestionsTableAdapter.Fill(exercisesDataSet.Loops_Questions); //get the questions table from the database
            loops_AnswersTableAdapter.Fill(exercisesDataSet.Loops_Answers); //get the answers table from the database
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            loops_QuestionsBindingSource.MoveNext(); //show next question 
            loops_AnswersBindingSource.MoveNext(); //update next answer
