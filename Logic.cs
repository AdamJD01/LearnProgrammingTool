//the form for learning Logic section
using System;
...
namespace LearnProgrammingTool
{
    public partial class frmLogic : Form
    {
        ...
        {
            logic_QuestionsTableAdapter.Fill(exercisesDataSet.Logic_Questions); //get the questions table from the database
            logic_AnswersTableAdapter.Fill(exercisesDataSet.Logic_Answers); //get the answers table from the database
